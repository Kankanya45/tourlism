...
class _StoreNamePageState extends State<StoreNamePage> {
  TextEditingController _idStoreController = TextEditingController();
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            _buildTextField(_idStoreController, 'ID Store'),
            _buildTextField(_nameStoreController, 'Name Store'),
  ...
  Future<void> _saveLocationData() async {
    final idStore = _idStoreController.text;
    final nameStore = _nameStoreController.text;
    final idType = _idTypeController.text;

    final apiUrl = 'http://localhost/Api_tourlism/StoreName.php';
